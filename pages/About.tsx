          ...
          <div className="lg:w-1/2 relative lg:sticky lg:top-32">
            ...
            <div className="space-y-6">
              <img 
                ...
                alt="Harvest Market produce and interior" 
              ...
              <div className="flex gap-4">
                <img 
                  ...
                  alt="La Terza Coffee preparation" 
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-8 text-stone-600">
              <p className="text-xl font-serif italic text-harvest-ivy leading-relaxed">
                "We are a specialty market in the heart of downtown Milford, built on the belief that quality should be a daily standard, not a luxury."
              </p>
              
              <div className="prose prose-stone max-w-none">
                <p className="leading-relaxed font-light text-lg mb-6">
                  Harvest Market began with a simple observation: downtown Milford needed a place where quality and convenience lived comfortably under one roof. We aren’t just another shop on the corner; we are locally owned and deeply rooted in the daily fabric of this community. Our philosophy is built on a food-first mindset—if an ingredient doesn't have a story worth telling, it doesn't make it onto our shelves.
                </p>
                
                <p className="leading-relaxed font-light text-lg mb-6">
                  We believe that the best food is often the most straightforward. That’s why we partner with <span className="font-semibold text-harvest-ivy">La Terza Roasterie</span> for beans that respect the craft, and regional family farms for dairy and produce that haven't traveled across the country to reach you. Our mission isn't to reinvent the market, but to restore the integrity of the neighborhood grocery and café experience. We operate on the principle that the community deserves access to honest ingredients without the pretense often found in specialty shops.
                </p>
                
                <p className="leading-relaxed font-light text-lg">
                  Whether you are here for your first cup of the day or a quick grab-n-go lunch, you’re stepping into a space designed for reliability. We focus on the details—the crumb of our artisan sourdough, the temperature of our lattes, and the vibrancy of our local greens—so you can trust every choice you make here. Harvest Market is our contribution to the downtown Milford we love: a reliable, approachable anchor for the regulars and visitors alike. No ceremony, just good food and a place that fits naturally into your day.
                </p>
              </div>
              ...
              <div className="pt-12 border-t border-stone-100 grid grid-cols-1 sm:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-stone-500 font-light">From La Terza roasts to local dairy, we vet every supplier to ensure the highest quality for your table.</p>
                </div>
              </div>

              <div className="pt-12">
                <p className="font-serif italic text-3xl text-harvest-ivy">We look forward to seeing you downtown.</p>
                <div className="mt-4 flex items-center gap-3 text-stone-400">
                  <MapPin className="w-4 h-4" />
                  <span className="text-xs uppercase tracking-[0.2em] font-bold">308 Main St, Milford, OH</span>
                </div>
              </div>
            </div>
          </div>
